/**
 * The global name used across the application.
 */
const APP_NAME = "BubbleOS";
/**
...
/**
 * The name of the author who developed the application.
 */
...
/**
 * If the application is in beta or not. `true` if it is in beta, else, `false`.
 */
const IN_BETA = true;
/**
 * If the timebomb for the application has been activated. `true` if the timebomb is activated, else, `false`.
 */
const TIMEBOMB_ACTIVATED = true;
/**
 * The expiry date of the application. If `TIMEBOMB_ACTIVATED` **and** `IN_BETA` are both `true`, the shell will always check on startup if the current date has surpassed the expiry date.
 *
 ...
 */
const EXPIRY_DATE = new Date(2023, 5, 14);
